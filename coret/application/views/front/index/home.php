...
.shadow-table{
  ...
  <thead style = "background-color: #e8f6fe;">
    <tr >
      <th width="20px"> </th>
			...
			<div id="grid-container" class="cbp-l-grid-projects">
					<ul>
						...
						<li class="cbp-item web-design logo">
							<div class="cbp-caption">
								<div class="cbp-caption-defaultWrap">
										<img src="application/views/product_pic/2.jpg" alt=""  class="img-responsive" />
								</div>
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
											<a href="application/views/product_pic/2.jpg" class="cbp-lightbox cbp-l-caption-buttonRight" data-title="World Clock Widget<br>by Paul Flavius Nechita">瀏覽大圖</a>
										</div>
									</div>
								</div>
							</div>
						...
						<li class="cbp-item graphic logo">
							<div class="cbp-caption">
								<div class="cbp-caption-defaultWrap">
										<img src="application/views/product_pic/3.jpg" alt=""  class="img-responsive" />
								</div>
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
										
											<a href="application/views/product_pic/3.jpg" class="cbp-lightbox cbp-l-caption-buttonRight" data-title="To-Do Dashboard<br>by Tiberiu Neamu">瀏覽大圖</a>
										</div>
									</div>
								</div>
							</div>
						...
						<li class="cbp-item web-design graphic">
							<div class="cbp-caption">
								<div class="cbp-caption-defaultWrap">
									<img src="application/views/product_pic/4.jpg" alt=""  class="img-responsive" />
								</div>
								<div class="cbp-caption-activeWrap">
									<div class="cbp-l-caption-alignCenter">
										<div class="cbp-l-caption-body">
										
											<a href="application/views/product_pic/4.jpg" class="cbp-lightbox cbp-l-caption-buttonRight" data-title="Events and  More<br>by Tiberiu Neamu">瀏覽大圖</a>
										</div>
									</div>
								</div>
							</div>
