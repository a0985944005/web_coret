                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h1>G&C</h1>                            		
                                    <h3 style="text-align:center;color:#fff;">請填寫下列資訊以便驗證帳號</a></h3>
									  <? if($check_error!=''){?><div style="color:#F00; font-size:14px;">※帳戶資訊錯誤無法驗證</div><? };?>                                   
                            ...
                            <div class="form-bottom">
			                    <form id="defaultForm" method="post" class="form-horizontal" action="index.php/front_login/remail/<?=$secret_code?>">
